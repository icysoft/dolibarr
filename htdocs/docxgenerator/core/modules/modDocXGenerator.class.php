 ...
 *
 *  \file       htdocs/mymodule/core/modules/modDocXGenerator.class.php
 *  \ingroup    mymodule
 ...
 */
class modDocXGenerator extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 565463; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'docxgenerator';
        ...
        $this->description = "Dolibarr module for docx generation";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Create docx documents from templates";
        ...
        */
        ...
        $this->rights[$r][1] = 'Read objects of DocXGenerator';	// Permission label
        ...
        $r++;
        $this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Create/Update objects of DocXGenerator';	// Permission label
        $this->rights[$r][3] = 0;	// Permission label
        $this->rights[$r][4] = 'write';				// In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $r++;
        $this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Delete objects of DocXGenerator';	// Permission label
        $this->rights[$r][3] = 0;	// Permission label

...
/**
 * 	\defgroup   avoloidivers     Module MyModule
 *  \brief      MyModule module descriptor.
 *
 *  \file       htdocs/avoloidivers/core/modules/modAvoloiDivers.class.php
 *  \ingroup    avoloidivers
 ...
 */
class modAvoloiCustomTypes extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 565466; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'avoloicustomtypes';
        ...
        $this->description = "Dolibarr module to manage custom types";
        ...
        $this->langfiles = array("avoloidivers@avoloidivers");
        ...
        */
        ...
        $this->rights[$r][1] = 'Manage Avoloi custom types';	// Permission label

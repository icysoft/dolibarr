...
/**
 * 	\defgroup   avoloiexport     Module MyModule
 *  \brief      MyModule module descriptor.
 *
 *  \file       htdocs/avoloiexport/core/modules/modAvoloiExport.class.php
 *  \ingroup    avoloiexport
...
class modAvoloiExport extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        */
        ...
        $this->rights[$r][1] = 'Export comptability';	// Permission label
